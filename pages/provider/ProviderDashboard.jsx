...
export default function ProviderDashboard() {
  ...
  const displayName = storedUser?.name || "Provider";
  const displayImage = storedUser?.profileImage || "";
  const displayInitial = displayName.charAt(0).toUpperCase();
  const category = storedUser?.serviceCategory || "Home Services";
  const experience = storedUser?.experience || "3 Years";
  const availability = storedUser?.availability || "Available";
  ...
  const services = [
    ...
    },
    {
      ...
      color: "#EAF2FF",
      icon: "🐶",
      sub: "New users are booking more",
    },
    {
      ...
      color: "#FDECF3",
      icon: "🔧",
      sub: "Excellent recent reviews",
    },
  ];

  const getStatusStyle = (status) => {
    if (status === "Completed") {
      return { bg: "#E7F7EA", color: "#297A43" };
    }
    if (status === "Confirmed") {
      return { bg: "#E8F0FF", color: "#4B6FC9" };
    }
            ...
            <Grid container spacing={3} alignItems="stretch">
              <Grid item xs={12} xl={7.5}>
                ...
                >
                  ...
                  and reply faster to users from one premium dashboard designed for
                  daily work.
                </Typography>
              ...
              <Grid item xs={12} xl={4.5}>
                <Paper
                  ...
                  sx={{
                    ...
                    borderRadius: "28px",
                    background:
                      "linear-gradient(135deg, #F1E8FF 0%, #EAF2FF 55%, #FFEAF3 100%)",
                    border: "1px solid #EEE6F5",
                  }}
                >
                  ...
                  <Grid container spacing={1.5}>
                    <Grid item xs={6}>
                      ...
                      >
                        <Typography sx={{ color: "#8A839C", fontSize: "0.85rem", mb: 0.5 }}>
                          Experience
                        </Typography>
                        <Typography sx={{ color: "#4A3D67", fontWeight: 800 }}>
                          {experience}
                        </Typography>
                      </Paper>
                    </Grid>
            ...
            <Grid item xs={12} xl={7}>
              ...
              >
                ...
                <Typography sx={{ color: "#7A7290", lineHeight: 1.85, mb: 2.5 }}>
                  ...
                  reply quickly, and maintain great reviews to improve visibility and
                  booking conversions.
                </Typography>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Typography sx={{ color: "#7D6A9A", mb: 0.7 }}>
                        This Month
                      </Typography>
                      <Typography
                        sx={{
                  ...
                  <Grid item xs={12} md={6}>
                    <Paper
                      ...
                      sx={{
                        p: 2.4,
                        borderRadius: "22px",
                        background: "linear-gradient(135deg, #EAF3FF, #F1F8FF)",
                        border: "1px solid #E4ECF8",
                      }}
                    >
                      <Typography sx={{ color: "#6B799A", mb: 0.7 }}>
                        Avg. Rating
                      </Typography>
                      <Typography
                        sx={{
                ...
                <Stack spacing={1.5}>
                  {[
                    ...
                    >
                      ...
                      <Typography sx={{ color: "#615871", fontWeight: 600 }}>
                        {text}
                      </Typography>
                    </Box>
                  ))}
