...
const Wallet = () => {
  ...
  const totalCredits = currentUser?.credits || 12;
  const spentCredits = 10;
  const earnedCredits = 7;
        ...
        <main style={styles.main}>
          ...
          <section style={styles.walletTopGrid}>
            <div style={styles.balanceCard}>
              ...
              <h2 style={styles.balanceValue}>{totalCredits} Credits</h2>
            ...
            <div style={styles.summaryGrid}>
              ...
              >
                ...
                <h3 style={styles.summaryValue}>{totalCredits}</h3>
              </div>

              <div
                style={{
                  ...styles.summaryCard,
                  background: "linear-gradient(135deg, #ffe6f3 0%, #ffd9eb 100%)",
                }}
              >
                <div style={styles.summaryIcon}>📤</div>
                <p style={styles.summaryLabel}>Spent</p>
                <h3 style={styles.summaryValue}>{spentCredits}</h3>
              </div>
              ...
              >
                ...
                <h3 style={styles.summaryValue}>{earnedCredits}</h3>
              </div>
            </div>
          </section>
              ...
              {transactions.map((item) => (
                ...
                >
                  <div style={styles.transactionServiceBox}>
                    ...
                    <div>
                      <h3 style={styles.transactionTitle}>{item.title}</h3>
                  ...
                  <div style={styles.subBox}>
                    ...
                    <div style={styles.metaPill}>{item.date}</div>
                  </div>
                  ...
                  <div style={styles.subBoxSmall}>
                    ...
                    <h4 style={styles.amountValue}>{item.amount}</h4>
                  </div>

                  <div style={styles.subBoxSmall}>
                    <p style={styles.subBoxLabel}>Status</p>
                    <div style={styles.metaPill}>{item.status}</div>
                  </div>
                </div>
              ))}
            </div>
...
const styles = {
  ...
  balanceCard: {
    background: "linear-gradient(135deg, #f7edff 0%, #fcecf5 100%)",
    border: "1px solid rgba(255,255,255,0.82)",
    borderRadius: "28px",
    padding: "24px",
  ...
  transactionRow: {
    ...
    boxShadow: "0 16px 32px rgba(124,96,190,0.08)",
    display: "grid",
    gridTemplateColumns: "1.3fr 0.8fr 0.7fr 0.7fr 0.7fr",
    gap: "14px",
    alignItems: "stretch",
  },

  transactionServiceBox: {
