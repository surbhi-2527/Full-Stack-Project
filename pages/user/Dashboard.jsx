...
const Dashboard = () => {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      text: "Your AC repair booking was confirmed.",
      time: "2 min ago",
      unread: true,
    },
    {
      id: 2,
      text: "Riya replied to your home cleaning request.",
      time: "12 min ago",
      unread: true,
    },
    {
      id: 3,
      text: "2 credits were added to your wallet.",
      time: "1 hour ago",
      unread: true,
    },
  ]);
  ...
  const stats = [
    {
      ...
      value: currentUser?.credits || 12,
      subtitle: "Use them to book services",
      icon: "⏱️",
      bg: "linear-gradient(135deg, #efe5ff 0%, #e7d8ff 100%)",
    },
    {
      title: "Active Bookings",
      value: 5,
      subtitle: "Current scheduled services",
      icon: "📋",
    ...
    },
    {
      title: "Unread Chats",
      value: 3,
      subtitle: "New provider replies",
      icon: "💬",
      bg: "linear-gradient(135deg, #ffe8f3 0%, #f8ddea 100%)",
    },
    {
      ...
      icon: "💖",
      bg: "linear-gradient(135deg, #fff1d9 0%, #fde9be 100%)",
    },
  ];
              ...
              <div style={styles.userMiniAvatar}>
                {userImage ? (
                  <img
                    src={userImage}
                    alt="User"
                    style={styles.userMiniAvatarImg}
                  />
                ) : (
                  initial
                )}
          ...
          <div style={styles.sidebarBottom}>
            <div style={styles.sidebarBottomCard}>
              <p style={styles.sidebarBottomText}>
                Explore trusted local providers, manage bookings, and stay
                    ...
                    <div style={styles.topProfileAvatar}>
                      {userImage ? (
                        <img
                          src={userImage}
                          alt="User"
                          style={styles.topProfileAvatarImg}
                        />
                      ) : (
                        initial
                      )}
          ...
          <section style={styles.hero}>
            <div style={styles.heroLeft}>
              ...
              <p style={styles.heroText}>
                Discover nearby services, book trusted providers, manage your
                wallet, and connect with people around you using time and skills
                as value.
              </p>
          ...
          <section style={styles.bottomGrid}>
            <div style={styles.panel}>
              ...
              <div style={styles.quickGrid}>
                <button
                  style={styles.quickCardPurple}
                  onClick={() => navigate("/user/services")}
                >
                  <span style={styles.quickEmoji}>🔍</span>
                  <div>
                    <h4 style={styles.quickTitleLight}>Browse Services</h4>
                    <p style={styles.quickTextLight}>
                      Find trusted providers around you
                    </p>
                  </div>
                </button>

                <button
                  style={styles.quickCardBlue}
                  onClick={() => navigate("/user/bookings")}
                >
                  <span style={styles.quickEmoji}>📅</span>
                  <div>
                    <h4 style={styles.quickTitleDark}>My Bookings</h4>
                    <p style={styles.quickTextDark}>
                      Check upcoming and completed services
                    </p>
                  </div>
                </button>

                <button
                  style={styles.quickCardPink}
                  onClick={() => navigate("/user/wallet")}
                >
                  <span style={styles.quickEmoji}>👛</span>
                  <div>
                    ...
                    <p style={styles.quickTextDark}>
                      Manage credits and transaction history
                    </p>
                  </div>
                </button>
              </div>
...
const styles = {
  page: {
    minHeight: "100vh",
    background:
      "linear-gradient(135deg, #faf6ff 0%, #f5efff 35%, #f8f1fb 65%, #eef5ff 100%)",
  ...
  blob1: {
    ...
    height: "280px",
    borderRadius: "50%",
    background: "rgba(180, 149, 255, 0.18)",
    filter: "blur(80px)",
  },
  ...
  blob2: {
    ...
    height: "260px",
    borderRadius: "50%",
    background: "rgba(255, 182, 222, 0.18)",
    filter: "blur(80px)",
  },
  ...
  sidebarBottomCard: {
    padding: "18px",
    borderRadius: "24px",
    background: "linear-gradient(135deg, #f5ecff 0%, #ffeaf5 100%)",
  },
  ...
  notificationBell: {
    ...
    height: "52px",
    borderRadius: "16px",
    background: "linear-gradient(135deg, #f4ebff 0%, #ffeaf4 100%)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    fontSize: "22px",
    border: "1px solid rgba(223, 210, 246, 0.9)",
    cursor: "pointer",
  },
  ...
  notificationDropdown: {
    ...
    border: "1px solid rgba(230, 213, 248, 0.9)",
    borderRadius: "20px",
    boxShadow: "0 16px 35px rgba(124,96,190,0.12)",
    padding: "14px",
    zIndex: 30,
  },
  ...
  notificationRow: {
    ...
    padding: "10px",
    borderRadius: "14px",
    background: "linear-gradient(135deg, #fcfaff 0%, #f5efff 100%)",
    border: "1px solid rgba(233, 226, 247, 0.8)",
  },
  ...
  topProfileAvatarOuter: {
    padding: "3px",
    borderRadius: "18px",
    background: "linear-gradient(135deg, #8f6bff 0%, #ffb1d0 100%)",
    boxShadow: "0 0 0 4px rgba(143, 107, 255, 0.08)",
  },
  ...
  dropdownLogout: {
    border: "none",
    background: "linear-gradient(135deg, #ff92bb 0%, #ffb1ce 100%)",
    color: "#fff",
    borderRadius: "12px",
    padding: "12px 14px",
    textAlign: "left",
  ...
  badge: {
    ...
    padding: "10px 16px",
    borderRadius: "999px",
    background: "linear-gradient(135deg, #efe6ff 0%, #ffeaf3 100%)",
    color: "#7c4cff",
    fontSize: "13px",
    fontWeight: "700",
    marginBottom: "18px",
  ...
  primaryBtn: {
    ...
    fontWeight: "800",
    cursor: "pointer",
    boxShadow: "0 14px 28px rgba(143, 107, 255, 0.2)",
  },
  ...
  floatBadge: {
    ...
    border: "1px solid rgba(223, 210, 246, 0.7)",
    color: "#735f93",
    fontSize: "13px",
    fontWeight: "700",
  },
  ...
  smallCard: {
    ...
    borderRadius: "20px",
    background: "rgba(255,255,255,0.82)",
    border: "1px solid rgba(220, 205, 246, 0.7)",
  },
  ...
  heroWidget: {
    ...
    borderRadius: "28px",
    padding: "22px",
    background: "linear-gradient(135deg, #f1e9ff 0%, #e7f2ff 55%, #ffeaf4 100%)",
  },
  ...
  progressFill: {
    width: "82%",
    height: "100%",
    background: "linear-gradient(135deg, #8f6bff 0%, #d497ff 100%)",
    borderRadius: "999px",
  },
  ...
  providerIcon: {
    ...
    height: "46px",
    borderRadius: "14px",
    background: "linear-gradient(135deg, #f7eefe 0%, #ffe9f4 100%)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    fontSize: "20px",
  ...
  statCard: {
    ...
    boxShadow: "0 14px 30px rgba(123, 97, 190, 0.06)",
  },
  ...
  quickCardPurple: {
    ...
    borderRadius: "22px",
    padding: "18px",
    background: "linear-gradient(135deg, #8f6bff 0%, #b78dff 100%)",
    display: "flex",
    alignItems: "center",
    gap: "14px",
    textAlign: "left",
  ...
  quickCardBlue: {
    ...
    borderRadius: "22px",
    padding: "18px",
    background: "linear-gradient(135deg, #e4f2ff 0%, #d3e9ff 100%)",
    display: "flex",
    alignItems: "center",
    gap: "14px",
    textAlign: "left",
  ...
  quickCardPink: {
    ...
    borderRadius: "22px",
    padding: "18px",
    background: "linear-gradient(135deg, #ffe7f3 0%, #f7dceb 100%)",
    display: "flex",
    alignItems: "center",
    gap: "14px",
    textAlign: "left",
  ...
  bookingItem: {
    ...
    border: "1px solid rgba(223, 210, 246, 0.8)",
    display: "flex",
    justifyContent: "space-between",
    alignItems: "center",
    gap: "12px",
