      ...
      <Container maxWidth={false} sx={{ px: { xs: 2, md: 3 }, py: 2 }}>
        ...
        >
          ...
          >
            ...
            >
              <Button onClick={() => scrollTo("explore")} sx={navBtn}>
                Explore
              </Button>
              <Button onClick={() => scrollTo("about")} sx={navBtn}>
                About
              </Button>
              <Button onClick={() => scrollTo("why-use")} sx={navBtn}>
                Why SkillSwap
              </Button>
              <Button onClick={() => scrollTo("how-it-works")} sx={navBtn}>
                How It Works
              </Button>
              <Button onClick={() => scrollTo("contact")} sx={navBtn}>
                Contact
              </Button>
            </Stack>
        ...
        >
          <Box>
            ...
            <Stack direction={{ xs: "column", sm: "row" }} spacing={2} sx={{ mt: 4, maxWidth: 540 }}>
              <Button
                onClick={() => navigate("/register")}
          ...
          >
            <Box sx={{ position: "relative", borderRadius: "28px", overflow: "hidden" }}>
              <Box
                component="img"
                src={heroImage}
                alt="SkillSwap community"
                sx={{ width: "100%", display: "block", borderRadius: "28px" }}
              />
          ...
          >
            ...
            >
              <Box
                ...
                src={aboutImage}
                alt="About SkillSwap"
                sx={{ width: "100%", borderRadius: "25px", display: "block" }}
              />
            </Paper>

            <Box>
              <Typography sx={{ fontSize: { xs: "2.1rem", md: "2.9rem" }, fontWeight: 900, color: "#583A86", mb: 2 }}>
                About SkillSwap
              </Typography>

              <Typography sx={{ color: "#6E6186", fontSize: "1rem", lineHeight: 1.9, mb: 2 }}>
              ...
              <Typography sx={{ color: "#6E6186", fontSize: "0.98rem", lineHeight: 1.9, mb: 3 }}>
        ...
        {/* WHY USE SKILLSWAP */}
        <InfoSection id="why-use" title="Why Use SkillSwap" subtitle="SkillSwap helps people save money, share value, and strengthen local communities through meaningful skill exchange." items={whyUseSkillSwap} />

        {/* HOW IT WORKS */}
        <InfoSection id="how-it-works" title="How It Works" subtitle="SkillSwap turns everyday skills into a powerful local support system through simple and easy steps." items={steps} />
        ...
        <Box id="contact" sx={{ mt: { xs: 7, md: 9 } }}>
          ...
          >
            <Box>
              <Typography sx={{ fontSize: { xs: "1.9rem", md: "2.6rem" }, fontWeight: 900, color: "#583A86", mb: 1.2 }}>
                Contact Us
              </Typography>

              <Typography sx={{ color: "#776C8D", lineHeight: 1.8, fontSize: "1rem", mb: 2.5, maxWidth: 620 }}>
        ...
        {/* FOOTER */}
        <Box sx={{ mt: 5, pb: 2, textAlign: "center" }}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            ...
            <Typography sx={{ fontSize: "1.22rem", fontWeight: 800, color: "#4D3B72", mb: 1 }}>
              {item.title}
            </Typography>

            <Typography sx={{ color: "#776C8D", lineHeight: 1.8, fontSize: "0.95rem" }}>
              {item.text}
            </Typography>
          </Paper>
        ))}
